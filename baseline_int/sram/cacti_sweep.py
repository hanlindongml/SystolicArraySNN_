...
class CactiSweep(object):
    def __init__(self, bin_file='./cacti', csv_file='cacti_sweep.csv', default_json='./default.json', default_dict=None):
    ...
    def _run_cacti(self, index_dict):
        ...
        print(f"Running cacti with args: {args}")
    ...
    def get_data(self, index_dict):
        ...
        if len(data) == 0:
            ...
            # DataFrame.append is deprecated, use concat instead
